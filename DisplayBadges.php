...
class DisplayBadges extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'classname' => 'badges_widget',
            'description' => "Display a set of Badges (named XXFoo.inc) within the widget. The path is specified as an offset from the Blog's base URL."
        );
        parent::__construct( 'badges_widget', 'Display Badges' );
...
//
function register_badges_widget() {
    register_widget( 'DisplayBadges' );
}
add_action( 'widgets_init', 'register_badges_widget' );
